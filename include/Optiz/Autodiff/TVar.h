...
/**
 * @brief Forward automatic differentiation expression with a templated scalar
 * and maximum of k variables. Using with differentiable scalar types allows for
 * differentiable gradient/hessian.
 *
 * @tparam T Scalar type. Can be double, float, or other differentiable
 * expression type, e.g. Var, TVar, TDenseVar, etc.
